...
func (o *DeleteProductNoContent) Error() string {
	return fmt.Sprintf("[DELETE /{id}][%d] deleteProductNoContent ", 204)
}
...
func (o *DeleteProductNotFound) Error() string {
	return fmt.Sprintf("[DELETE /{id}][%d] deleteProductNotFound  %+v", 404, o.Payload)
}

func (o *DeleteProductNotFound) GetPayload() *models.ErrGenericError {
	return o.Payload
}
...
func (o *DeleteProductNotImplemented) Error() string {
	return fmt.Sprintf("[DELETE /{id}][%d] deleteProductNotImplemented  %+v", 501, o.Payload)
}

func (o *DeleteProductNotImplemented) GetPayload() *models.ErrGenericError {
	return o.Payload
}
